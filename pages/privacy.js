...
const About = () => (
  <Layout title="Privacy">
    <Container maxW="container.md">
      ...
      website is hosted on Vercel. Vercel Analytics is enabled on this website which
      is used to collect anonymous information about the visitors to the website.
      </Box>
      <Divider mb={6}/>
      <Text fontSize={18} fontWeight='medium'>Countless (Chrome Extension)</Text>
      <Text fontSize={13} fontWeight={500} opacity={0.6} mb={4}>
        Effective as of 24 December 2022
      </Text>
      <Box fontSize={14} color={useColorModeValue('#222', '#B5B5B5')} mb={12}>
      This privacy policy applies to the countless extension (the "Extension").
      The Extension is provided by Mayur Bhoi and is intended for use as is. By
      using the Extension, you consent to the collection, use, and sharing of
      ...
      As the Extension does not collect any information, there is no information
      to use.
      <Heading>Is the collected information shared with third parties?</Heading>
      As the Extension does not collect any information, there is no information
