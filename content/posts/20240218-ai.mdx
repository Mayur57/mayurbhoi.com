...
<Tweet
  id='1758192957386342435'
  caption='OpenAI announces their text-to-video model, Sora'
/>
...
<sup>[1]</sup> [The LLM Index](https://sapling.ai/llm/index): This website is great to
learn about LLMs as they release and keep track of the developments in the field in
general. The growth is astonishing.
...
*Vox Media* - This article is a great read about the impact of the iPhone over the decade
after its release.

<sup>[3]</sup> [How OpenAI is approaching 2024 worldwide
elections](https://openai.com/blog/how-openai-is-approaching-2024-worldwide-elections),
*OpenAI* - OpenAI highlights the risk and importance of mitigation of abuse of models
released to the public. Interesting read regarding the impact of AI and safety.
