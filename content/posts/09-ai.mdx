---
title: AI, LLMs, and My Existential Crisis
...
<Tweet id="1758193792778404192" caption="Checkout the prompts provided and their resultant video in quotes made by Sora. It's mighty impressive!" />
...
<Callout emoji="🚨" title="Disclaimer">
    This post was entirely written by humans with no involvement of AI at any point.
</Callout>
...
<sup>[1]</sup> [The LLM Index](https://sapling.ai/llm/index): This website is great to learn about LLMs as they release and keep track of the developments in the field in general. The growth is astonishing.

<sup>[2]</sup> [How Apple’s iPhone changed the world](https://www.vox.com/2017/6/26/15821652/iphone-apple-10-year-anniversary-launch-mobile-stats-smart-phone-steve-jobs), *Vox Media* - This article is a great read about the impact of the iPhone over the decade after its release.

<sup>[3]</sup> [How OpenAI is approaching 2024 worldwide elections](https://openai.com/blog/how-openai-is-approaching-2024-worldwide-elections), *OpenAI* - OpenAI highlights the risk and importance of mitigation of abuse of models released to the public. Interesting read regarding the impact of AI and safety.