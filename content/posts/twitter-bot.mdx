...
<Callout emoji="⚠️" title="Note">
Due to changes of March 30, 2023 to the Twitter API pricing, making Twitter apps and obtaining API keys is now behind a paid subscription. Hence, to follow this tutorial you’d need to spend a minimum of USD 100.
I strongly condemn these changes as it hinders beginners and developers from wanting to experiment and build with the Twitter API. This article will be left up for reference also serving as a symbol of disagreement.
</Callout>
