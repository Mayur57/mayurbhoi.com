...
<Image
  ...
  alt='An attempt at clean minimal design'
  width={1280}
  height={728}
  quality={100}
/>

There is no backend. Everything from PDF generation to AI generation to saving progress is done on the client side. The progress is saved in-browser, and AI-based insights are generated using an integration with the **[Groq API](https://www.groq.com)**. Groq provides a very easy experience with respect to interfacing with various large language models. I chose **[Llama 2 70B](https://ai.meta.com/llama/)** because it is a good balance of being fast and useful _(and it is open-source too!)_. The language model analyzes user responses to provide summaries and personality insights.
...
All of the code for this site will be open sourced at some point after my new year break. Shipping software quickly comes at a cost. This cost is the quality of the code. The quality of code at the time of writing this post is not up to the mark where it might be useful for anybody. Hence, in some time, the code will be cleaned up and released for public.
...
I’ve always believed that small rituals and habits can have profound impacts on personal growth. Building this web app felt like an extension of that philosophy—not just for myself but for anyone who wants to take a step back and reflect. If this can help even a few people grow and bring about positive change in their lives, I’ll consider it a success.

Will you use the app? What features would make you want to share it with others? I’d love to hear your thoughts—and who knows, maybe your feedback will inspire the next version. Tweet at me [@mayurbhoii](https://x.com/mayurbhoii) if you use the app or have any feedback to share.
